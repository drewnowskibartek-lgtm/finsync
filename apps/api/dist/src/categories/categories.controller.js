...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_2.ApiOperation)({ summary: 'Lista kategorii (globalne + własne)' }),
...
__decorate([
    ...
    (0, feature_decorator_1.FeatureGate)('CUSTOM_CATEGORIES'),
    (0, roles_decorator_1.Roles)('ADMIN', 'USER'),
    (0, swagger_2.ApiOperation)({ summary: 'Dodaj własną kategorię (Pro)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
